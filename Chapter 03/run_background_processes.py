# merged_run_background_guessing_game_daemon.py
...
if __name__ == '__main__':
    ...
    NO_background_process.daemon = False  # non-daemon process

    background_process.start()
    NO_background_process.start()

    # Only wait for non-daemon
    NO_background_process.join()
    
    print("Main process exiting (daemon may still be running).")
